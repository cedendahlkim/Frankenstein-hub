...
export default function Dashboard() {
  ...
  const handleInvokeAgent = async (endpoint: string) => {
          ...
          <div className="lg:col-span-3">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <AgentCard
                ...
                onInvoke={() =>
                  handleInvokeAgent('/agents/analyst/execute')
                }
              />
              <AgentCard
                ...
                onInvoke={() =>
                  handleInvokeAgent('/agents/creativist/draft')
                }
                requiresStepUp={true}
              />
              <AgentCard
                ...
                isConnected={true}
                onInvoke={() =>
                  handleInvokeAgent('/agents/critic/review')
                }
                isCibaFlow={true}
              />
            </div>
